...
# MAGIC
# MAGIC To do so, we'll need an orchestrator to schedule the data ingestion (trigger the STP pipeline) every hour, and then call our model to infere the image severity. 
# MAGIC
...
# MAGIC
# MAGIC Open the <a dbdemos-workflow-id="init-job" href="#job/21440255946608/tasks" target="_blank">FSI Smart Claims workflow</a> to start exploring Databricks orchestration capabilities!
