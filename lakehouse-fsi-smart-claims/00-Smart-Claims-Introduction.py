...
# MAGIC %md
# MAGIC
# MAGIC Open the [Spark Declarative Pipeline notebook]($./01-Data-Ingestion/01.1-SDP-Ingest-Policy-Claims). 
# MAGIC
# MAGIC This will create a <a dbdemos-pipeline-id="sdp-fsi-smart-claims" href="#joblist/pipelines/71c6a196-0e74-4e44-86bc-314cf4063cfd" target="_blank">SDP Pipeline</a> running in batch or streaming.
# MAGIC
...
# MAGIC %md
# MAGIC Open the [04-Workflow-Orchestration]($./04-Workflow-Orchestration/04-Workflow-Orchestration-Smart-Claims)  notebook to schedule or <a dbdemos-workflow-id="init-job" href="#job/21440255946608/tasks" target="_blank">access your workflow</a> (data ingetion, model re-training, dashboard update etc)
