...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1444828305810485&notebook=%2F01-Data-Ingestion%2F01.1-DLT-Ingest-Policy-Claims&demo_name=lakehouse-fsi-smart-claims&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-smart-claims%2F01-Data-Ingestion%2F01.1-DLT-Ingest-Policy-Claims&version=1&user_hash=1868b144de45687ae4c3cc1223c535cf80acd3c5475593edeb5b8d2642fab04a">

# COMMAND ----------

# MAGIC %md
# MAGIC
# MAGIC This demo started for you a <a dbdemos-pipeline-id="sdp-fsi-smart-claims" href="#joblist/pipelines/71c6a196-0e74-4e44-86bc-314cf4063cfd" target="_blank">SDP Pipeline</a> using this notebook! Explore it to see its execution out of the box.
